...
## Logging Issues
All issues should be created using the [new issue form](https://github.com/ruiquelhas/coutts/issues/new). Clearly describe the issue including steps
...
* [Pull requests](https://help.github.com/articles/using-pull-requests/) should be made to the [master branch](https://github.com/ruiquelhas/coutts/tree/master).
